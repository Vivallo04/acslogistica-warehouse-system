...
import { PrintJob, PrintSettings, PrintQueueState, DEFAULT_PRINT_SETTINGS } from "@/lib/print-types"
          ...
          <Dialog open={showSettings} onOpenChange={setShowSettings}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Ajusta las preferencias de impresión automática
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="space-y-6 py-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateSettings({ autoPrintEnabled: checked })}
                  />
                </div>
      ...
      {queue.length > 0 && (
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm">Cola de Impresión</CardTitle>
          </CardHeader>
          <CardContent>
